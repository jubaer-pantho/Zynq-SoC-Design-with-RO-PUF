...
proc create_root_design { parentCell } {
  ...
  # Create instance: ro_puf_0, and set properties
  set ro_puf_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:ro_puf:1.0 ro_puf_0 ]
  ...
  connect_bd_net -net axi_gpio_0_gpio2_io_o [get_bd_pins axi_gpio_0/gpio2_io_o] [get_bd_pins ro_puf_0/challenge]
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins ro_puf_0/selector]
  connect_bd_net -net axi_gpio_1_gpio2_io_o [get_bd_pins axi_gpio_1/gpio2_io_o] [get_bd_pins ro_puf_0/enable]
  ...
  connect_bd_net -net ro_puf_0_leds [get_bd_pins axi_gpio_1/gpio_io_i] [get_bd_pins ro_puf_0/leds]
