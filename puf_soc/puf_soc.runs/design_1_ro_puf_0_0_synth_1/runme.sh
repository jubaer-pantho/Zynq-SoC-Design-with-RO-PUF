...
HD_PWD='C:/workspace/2020/vivado-project/puf_soc/puf_soc.runs/design_1_ro_puf_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_ro_puf_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_ro_puf_0_0.tcl
